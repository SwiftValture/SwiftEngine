...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		listenText = new FlxText(0, 10, FlxG.width, "PRESS TAB TO LISTEN", 20);
		listenText.setFormat(Paths.font("vcr.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
